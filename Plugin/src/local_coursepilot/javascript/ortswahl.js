 ...
 * Ordner erst beim Abschliessen, siehe local_coursepilot\ortswahl_lib::apply()).
 *
...
(function () {
    ...
    var dataEl = document.getElementById('coursepilot-ortswahl-data');
    if (!dataEl) {
        return;
    }
    ...
    function renderProgress() {
        var container = el('coursepilot-ortswahl-progress');
        container.innerHTML = '';
        ['kontextbereich', 'materialbestand'].forEach(function (target) {
            var sel = selections[target];
        ...
        el('coursepilot-ortswahl-finish').disabled = !(selections.kontextbereich.type && selections.materialbestand.type) || overlapLocked;
    }
    ...
    function openModal(target) {
        ...
        renderInstances();
        el('coursepilot-ortswahl-breadcrumb').innerHTML = '';
