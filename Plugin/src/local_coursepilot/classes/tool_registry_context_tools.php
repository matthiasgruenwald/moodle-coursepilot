...
final class tool_registry_context_tools {
     ...
     */
    public const TOOLS = [
        'coursepilot_list_context_files' => [
            'function' => 'local_coursepilot_list_context_files',
            'classname' => 'local_coursepilot\external\list_context_files',
            'wsdescription' => 'Lists the calling teacher\'s Coursepilot context area (own working area only).',
            'description' => 'Listet den eigenen Kontextbereich der angemeldeten Lehrkraft auf '
                ...
                . 'aus coursepilot_list_skills als "Altbestand offen" erkennbar) - nur lesbar, wirkt nur solange offen.',
            'schema' => [
                'properties' => [
        ...
        'coursepilot_describe_module_fields' => [
            'function' => 'local_coursepilot_describe_module_fields',
            'classname' => 'local_coursepilot\external\describe_module_fields',
            'wsdescription' => 'Reads the field catalog for a module type (fields, presets) or, without a '
                . 'modname, the list of module types Coursepilot catalogs at all.',
            'description' => 'Liefert den Feldkatalog: was eine Aktivitätsart einstellen kann, mit deutscher '
                ...
                . 'Coursepilot geführten Aktivitätsarten (z.B. label). Mit "modname" die häufig gesetzten Felder '
        ...
        'coursepilot_read_context_file' => [
            'function' => 'local_coursepilot_read_context_file',
            'classname' => 'local_coursepilot\external\read_context_file',
            'wsdescription' => 'Reads one file from the calling teacher\'s Coursepilot context area (own working '
                . 'area only).',
            'description' => 'Liest eine einzelne Datei aus dem eigenen Kontextbereich der angemeldeten '
                ...
                . 'Kopieren die gelesenen Inhalte anschliessend über coursepilot_write_context_file mit '
        ...
        'coursepilot_write_context_file' => [
            'function' => 'local_coursepilot_write_context_file',
            'classname' => 'local_coursepilot\external\write_context_file',
            'wsdescription' => 'Creates or fully overwrites one .md file in the calling teacher\'s Coursepilot '
            ...
            'description' => 'Legt eine .md-Datei im eigenen Kontextbereich der angemeldeten Lehrkraft an oder '
                ...
                . 'einen offenen Ausstand (aus coursepilot_list_skills) im selben Aufruf abzuhaken. "nur_anlegen": '
                . 'true legt nur an und überschreibt nie - für das Kopieren aus dem Altbestand (vorheriger Ort, '
                . 'aus coursepilot_list_context_files/coursepilot_read_context_file mit "vorheriger_ort": true '
            ...
            'schema' => [
                'properties' => [
                    ...
                    'ausstand' => [
                        'type' => 'string',
                        'description' => 'Optional: Kennung eines offenen Ausstands (aus coursepilot_list_skills) - '
        ...
        'coursepilot_append_context_file' => [
            'function' => 'local_coursepilot_append_context_file',
            'classname' => 'local_coursepilot\external\append_context_file',
            'wsdescription' => 'Appends content to one .md file in the calling teacher\'s Coursepilot '
            ...
            'description' => 'Hängt Inhalt an eine .md-Datei im eigenen Kontextbereich der angemeldeten '
                ...
                . 'Ausstand (aus coursepilot_list_skills) im selben Aufruf abzuhaken. "expected_contenthash" wirkt '
        ...
        'coursepilot_list_material_files' => [
            'function' => 'local_coursepilot_list_material_files',
            'classname' => 'local_coursepilot\external\list_material_files',
            'wsdescription' => 'Lists the calling teacher\'s Coursepilot material folder (own working area '
        ...
        'coursepilot_upload_material_file' => [
            'function' => 'local_coursepilot_upload_material_file',
            'classname' => 'local_coursepilot\external\upload_material_file',
            'wsdescription' => 'Creates or fully overwrites one file in the calling teacher\'s Coursepilot '
        ...
        'coursepilot_preview_material_file' => [
            'function' => 'local_coursepilot_preview_material_file',
            'classname' => 'local_coursepilot\external\preview_material_file',
            'wsdescription' => 'Returns a shrunk preview (longest edge 768px, JPEG) of an image in the calling '
                . 'teacher\'s Coursepilot material folder, so the model can actually see it - choose a crop, '
        ...
        'coursepilot_crop_material_file' => [
            'function' => 'local_coursepilot_crop_material_file',
            'classname' => 'local_coursepilot\external\crop_material_file',
            'wsdescription' => 'Crops one image in the calling teacher\'s Coursepilot material folder to a '
        ...
        'coursepilot_report_loose_material_files' => [
            'function' => 'local_coursepilot_report_loose_material_files',
            'classname' => 'local_coursepilot\external\report_loose_material_files',
        ...
        'coursepilot_delete_material_files' => [
            'function' => 'local_coursepilot_delete_material_files',
            'classname' => 'local_coursepilot\external\delete_material_files',
        ...
        'coursepilot_clone_activity' => [
            'function' => 'local_coursepilot_clone_activity',
            'classname' => 'local_coursepilot\external\clone_activity',
        ...
        'coursepilot_report_clone_lineage' => [
            'function' => 'local_coursepilot_report_clone_lineage',
            'classname' => 'local_coursepilot\external\report_clone_lineage',
            ...
            'description' => 'Meldet je Frage eines Tests (i.d.R. das Ergebnis eines vorherigen clone_activity), '
                ...
                . '(moodle/question:viewall), keine eigene Coursepilot-Schreibrechte.',
            'schema' => [
                'properties' => [
        ...
        'coursepilot_list_skills' => [
            'function' => 'local_coursepilot_list_skills',
            'classname' => 'local_coursepilot\external\list_skills',
            'wsdescription' => 'Lists the Coursepilot skill corpus shipped with the plugin: name, trigger, kind '
            ...
            'description' => 'Listet den mit dem Plugin ausgelieferten Skill-Korpus: je Eintrag Name, Auslöser, '
                ...
                . dispatcher::HANDSHAKE_INSTRUCTIONS . ' Danach coursepilot_get_skill(name) für den eigentlichen Text.',
            'schema' => null,
            'capability' => 'local/coursepilot:use',
        ],
        'coursepilot_get_skill' => [
            'function' => 'local_coursepilot_get_skill',
            'classname' => 'local_coursepilot\external\get_skill',
            'wsdescription' => 'Delivers one skill corpus entry by name (from coursepilot_list_skills): content, '
                . 'names of referenced parts, and the corpus version. Unknown or path-like names are rejected, the '
                . 'error names the valid names.',
            'description' => 'Liefert einen Eintrag aus dem Skill-Korpus per Name (aus coursepilot_list_skills): '
            ...
            'schema' => [
                'properties' => [
                    'name' => ['type' => 'string', 'description' => 'Skill-Name aus coursepilot_list_skills, kein Pfad'],
                ],
                'required' => ['name'],
            ],
            'capability' => 'local/coursepilot:use',
        ...
        'coursepilot_dismiss_ausstand' => [
            'function' => 'local_coursepilot_dismiss_ausstand',
            'classname' => 'local_coursepilot\external\dismiss_ausstand',
            ...
            'description' => 'Verwirft einen Eintrag der Ausstandsnotiz ausdrücklich (Kennung aus '
                . 'coursepilot_list_skills, Feld "ausstände") - für Inhalt, der nicht mehr nachgetragen werden soll. '
            ...
            'schema' => [
                'properties' => [
                    'kennung' => ['type' => 'string', 'description' => 'Kennung des Ausstands, aus coursepilot_list_skills'],
                ],
                'required' => ['kennung'],
            ],
            'capability' => null,
        ...
        'coursepilot_create_werkbank_download_links' => [
            'function' => 'local_coursepilot_create_werkbank_download_links',
            'classname' => 'local_coursepilot\external\create_werkbank_download_links',
        ...
        'coursepilot_dismiss_altbestand' => [
            'function' => 'local_coursepilot_dismiss_altbestand',
            'classname' => 'local_coursepilot\external\dismiss_altbestand',
            ...
            'description' => 'Beendet den Altbestand ausdrücklich (vorheriger Ort des Kontextbereichs nach einem '
                . 'Ortswechsel, aus coursepilot_list_skills als "Altbestand offen" erkennbar) - nach dem Kopieren, '
