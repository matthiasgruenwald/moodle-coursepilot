 ...
 * einen eigenen, unauthentifizierten Endpunkt ({@see \local_coursepilot\werkbank_ticket}
...
final class werkbank_ticket {
    ...
    public const TABLE = 'local_coursepilot_werkbank_ticket';
    ...
    public static function issue(string $path): array {
        ...
        return [
            ...
            'url' => $CFG->wwwroot . '/local/coursepilot/werkbank/download.php?ticket=' . $secret,
        ];
    }
