...
class get_course_catalog extends external_api {
    ...
    /**
     * Bildet den vom Moodle-Kern persistierten assign_plugin_config-Namen auf
     * das zugehoerige Formularfeld ab. Portiert aus
     * local_coursepilot\assign_settings::plugin_config_field() - nur diese
     * eine kleine, rein lesende Zuordnung wird gebraucht, nicht die gesamte
     * Schreibpfad-Klasse.
     *
