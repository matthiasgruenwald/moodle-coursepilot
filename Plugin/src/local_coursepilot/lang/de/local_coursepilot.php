...
$string['coursepilot:use'] = 'Coursepilot in einem Kurs nutzen';
$string['coursepilot:useremote'] = 'KI-Chat mit Coursepilot verbinden (Fernzugriff)';
$string['coursepilot:viewhistory'] = 'Änderungsverlauf von Aktivitäten einsehen';
...
$string['webdavauthunsupported'] = 'Diese WebDAV-Verbindung nutzt nicht mehr https mit Basic-Anmeldung — das unterstützt Coursepilot nicht. Bitte auf der Ortswahlseite ({$a}) korrigieren.';
...
$string['myconnections'] = 'Meine Coursepilot-Verbindungen';
$string['myconnectionsintro'] = 'KI-Anwendungen, die Sie mit Coursepilot verbunden haben. Ein Widerruf entwertet die Verbindung sofort.';
...
// surface.php.
$string['surface'] = 'Coursepilot-Datenoberfläche';
$string['surfaceintro'] = 'Coursepilot gibt ausschließlich lehrkraftbezogene Kursgestaltung frei. Diese Seite zeigt die vereinbarte Oberfläche und gleicht sie mit der auf dieser Instanz tatsächlich registrierten ab.';
...
$string['authorizetitle'] = 'Coursepilot verbinden';
$string['authorizetitleclient'] = 'Coursepilot mit {$a} verbinden';
...
$string['consentgranted'] = '<strong>Freigegeben:</strong> Kursliste, Abschnitte, Aktivitäten und deren Inhalte (Seitentexte, Aufgabenstellungen, Fragen) sowie Ihre Coursepilot-Kontextdateien.';
$string['consentdenied'] = '<strong>Nicht freigegeben:</strong> Abgaben, Forenbeiträge, Testversuche, Bewertungen, Teilnehmendenlisten.';
$string['consenttransfer'] = '<strong>Übertragung an den KI-Anbieter:</strong> Alles, was Coursepilot auf Anfrage liest, wird an den KI-Anbieter übertragen und dort verarbeitet. Es läuft nichts im Hintergrund — übertragen wird nur, was ein Werkzeug auf Anfrage zurückgibt.';
...
$string['privacy:metadata:oauth_token'] = 'Zugriffs- und Erneuerungstoken, mit denen ein KI-Client im Namen der Lehrkraft auf Coursepilot zugreift.';
...
$string['privacy:metadata:cm_version_file'] = 'Verknuepfung eines Verlaufs-Standes mit den zu diesem Zeitpunkt vorhandenen Dateien der Aktivität (nur Metadaten, siehe local_coursepilot_cm_file). Faellt zusammen mit dem zugehoerigen Stand weg.';
...
$string['restrictioninvalidstatus'] = 'Ungültiger Wert {$a->value} für "{$a->field}". Erlaubt: complete, incomplete, pass, fail. Nichts wurde geschrieben.';
...
$string['webdavcheck2name'] = 'Coursepilot: Nutzerinstanzen erlaubt';
...
$string['webdavcheck3name'] = 'Coursepilot: WebDAV-Recht im Nutzerkontext';
$string['webdavcheck3na'] = 'Nicht anwendbar: entweder ist der Repository-Typ „WebDAV" nicht aktiv, oder niemand hat gerade eine aktive Coursepilot-Verbindung.';
$string['webdavcheck3ok'] = 'Alle Personen mit aktiver Coursepilot-Verbindung haben das Recht „repository/webdav:view" im eigenen Nutzerkontext.';
...
$string['webdavcheck4name'] = 'Coursepilot: Zugelassene Speicher für personenbezogene Daten';
