...
final class werkbank_ticket_test extends \advanced_testcase {
    ...
    public function test_issue_and_redeem_delivers_original_bytes_with_matching_sha1(): void {
        ...
        $this->assertStringContainsString('/local/coursepilot/werkbank/download.php?ticket=', $link['url']);
    ...
    public function test_second_redemption_is_rejected(): void {
        ...
        $this->expectExceptionMessageMatches('/' . preg_quote(get_string('werkbankticketinvalid', 'local_coursepilot'), '/') . '/');
        werkbank_ticket::redeem($secret);
    }
    ...
    public function test_expired_ticket_is_rejected(): void {
        ...
        $this->expectException(\moodle_exception::class);
        $this->expectExceptionMessageMatches('/' . preg_quote(get_string('werkbankticketexpired', 'local_coursepilot'), '/') . '/');
        werkbank_ticket::redeem($secret);
    }
    ...
    public function test_changed_contenthash_is_rejected(): void {
        ...
        $this->expectException(\moodle_exception::class);
        $this->expectExceptionMessageMatches('/' . preg_quote(get_string('werkbankticketcontentchanged', 'local_coursepilot'), '/') . '/');
        werkbank_ticket::redeem($secret);
    }
    ...
    public function test_revoked_connection_rejects_redemption(): void {
        ...
        $this->expectException(\moodle_exception::class);
        $this->expectExceptionMessageMatches('/' . preg_quote(get_string('werkbankticketconnectionrevoked', 'local_coursepilot'), '/') . '/');
        werkbank_ticket::redeem($secret);
    }
    ...
    public function test_deleted_account_rejects_redemption(): void {
        ...
        $this->expectException(\moodle_exception::class);
        $this->expectExceptionMessageMatches('/' . preg_quote(get_string('werkbankticketaccountinactive', 'local_coursepilot'), '/') . '/');
        werkbank_ticket::redeem($secret);
    }
    ...
    public function test_redemption_without_a_known_issuing_connection_needs_some_active_connection(): void {
        ...
        $this->expectExceptionMessageMatches(
            '/' . preg_quote(get_string('werkbankticketconnectionrevoked', 'local_coursepilot'), '/') . '/'
        );
        werkbank_ticket::redeem($secret);
    }
