...
final class connection_ablageort_test extends \advanced_testcase {
    ...
    public function test_both_targets_are_offen_without_any_pointer(): void {
        ...
        $offen = get_string('ablageortoffen', 'local_coursepilot');
    ...
    public function test_marks_a_host_that_is_not_on_the_approved_list(): void {
        ...
        $this->assertContains(get_string('ablageortmarkernichtzugelassen', 'local_coursepilot'), $description['markers']);
    }
    ...
    public function test_does_not_mark_an_approved_host(): void {
        ...
        $this->assertNotContains(get_string('ablageortmarkernichtzugelassen', 'local_coursepilot'), $description['markers']);
    }
    ...
    public function test_marks_an_open_altbestand(): void {
        ...
        $this->assertContains(get_string('ablageortmarkeraltbestand', 'local_coursepilot'), $description['markers']);
    }
    ...
    public function test_marks_an_open_ausstand(): void {
        ...
        $this->assertContains(get_string('ablageortmarkerausstand', 'local_coursepilot'), $description['markers']);
    }
    ...
    public function test_marks_a_broken_pointer_with_a_missing_instance(): void {
        ...
        $expected = get_string('ablageortmarkerdefekt', 'local_coursepilot', get_string('ablageortdefektinstanzfehlt', 'local_coursepilot'));
