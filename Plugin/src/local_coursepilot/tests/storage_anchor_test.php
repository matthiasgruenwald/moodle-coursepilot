...
final class storage_anchor_test extends \advanced_testcase {
    ...
    public function test_second_place_root_is_configurable_independently(): void {
        $this->resetAfterTest();
        set_config('zweitortroot', 'anderswo', 'local_coursepilot');
        set_config('contextroot', 'unveraendert', 'local_coursepilot');
     ...
     * {@see \local_coursepilot\external\list_material_files_test::test_ort_werkbank_stays_in_moodle_when_material_is_external()} ab.
     */
    ...
    public function test_default_root_ignores_an_existing_pointer(): void {
        ...
        $this->assertSame('coursepilot', storage_anchor::default_root(context_files::area()));
        $this->assertSame('coursepilot-material', storage_anchor::default_root(material_files::area()));
    }
    ...
    public function test_list_entries_excludes_the_context_pointer_file(): void {
        ...
        $this->setUser($this->getDataGenerator()->create_user());
        $this->put_pointer(json_encode([
            'kontextbereich' => 'coursepilot',
            'materialordner' => 'coursepilot-material',
        ]));
