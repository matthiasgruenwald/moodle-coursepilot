 ...
 * ein, uebergibt an {@see \local_coursepilot\werkbank_ticket::redeem()}. Die
...
$toolname = 'coursepilot_werkbank_download';
...
if ($ticket === '') {
    ...
    echo json_encode(['error' => get_string('werkbankticketinvalid', 'local_coursepilot')]);
    return;
}

try {
    $delivery = werkbank_ticket::redeem($ticket);
} catch (\local_coursepilot\werkbank_ticket_redemption_failed $e) {
