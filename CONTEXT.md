...
_Avoid_: Umzugswerkzeug im Plugin, Kopieren ohne Bestätigung, am neuen Ort überschreiben, den Altbestand löschen oder Löschen anbieten, vom alten Ort weiterarbeiten, Werkbankdateien als Altbestand behandeln, Altbestand nach Frist oder Namensgleichheit von selbst schließen, eine Kette früherer Orte führen

**Ausstand**:
Gültiger Inhalt für den **Kontextbereich**, der am Speicher gescheitert ist: Er hat jede Prüfung bestanden und wäre geschrieben worden, wenn Speicher, Verbindung oder Ort funktioniert hätten. Ob die Ursache vorübergehend ist (Speicher antwortet nicht) oder bleibt (Instanz gelöscht, Anmeldung abgelehnt), spielt keine Rolle. Verloren ist verloren. Kein Ausstand ist ein Aufruffehler, den die KI sofort selbst behebt, und kein Konflikt, bei dem sie neu liest und zusammenführt: In beiden Fällen liegt der Inhalt noch im Gespräch und der Ablauf geht weiter ([#475](https://github.com/matthiasgruenwald/moodle-coursepilot/issues/475)).
...
**Nachtragen**:
Das Schreiben eines **Ausstands**, sobald der Speicher wieder antwortet. Der Inhalt kommt aus dem Gespräch, wenn es noch offen ist, sonst aus einer Rekonstruktion. Nachtragen legt an, ohne einen inzwischen gewachsenen Bestand zu überschreiben, und hakt den Eintrag der **Ausstandsnotiz** im selben Schritt ab.
